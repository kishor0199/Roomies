        ...
        return (
          <>
            ...
            <div className="col-md-3 offset-md-1 mt-1 mb-3">
              <div
                class="card"
                key={element.hostel_id}
                style={{ width: "20rem" }}
              >

                  {element && element.image1 === "null" && (
                    <img src="http://localhost:8080/uploads/a06fa97a-7b24-4aee-8a09-802c25699392undefined.png"></img>
                  )}
                  {element && element.image1 && (
                    <img src={`http://localhost:8080/` + element.image1}></img>
                  )}
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    <br></br>City : {element.city} <br></br> Rent :{" "}
                    {element.room_fee}
                  </p>
                  <a
                    href={"/hostel/" + element.hostel_id}
